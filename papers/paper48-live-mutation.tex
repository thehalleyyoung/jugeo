...
\midrule
$\ExecInj$  & \ppFortyEightExecTracked & \ppFortyEightExecElevated & \emph{highest} \\
$\EvalQ$    & \ppFortyEightEvalTracked & \ppFortyEightEvalElevated & \emph{high} \\
$\MPatch$   & \ppFortyEightPatchTracked & \ppFortyEightPatchElevated & \emph{moderate} \\
$\HotRel$   & \ppFortyEightReloadTracked & \ppFortyEightReloadElevated & \emph{lowest} \\
\midrule
...
\midrule
$\ExecInj$  & \subSiteMeanTime & \ppFortyEightExecPctile \\
$\EvalQ$    & \subSiteMeanTime & \ppFortyEightEvalPctile \\
$\MPatch$   & \subSiteMeanTime & \ppFortyEightPatchPctile \\
$\HotRel$   & \subSiteMeanTime & \ppFortyEightReloadPctile \\
\bottomrule
\end{tabular}
\end{center}
