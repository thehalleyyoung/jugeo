...
overhead per tracked event.  The Runtime
...
\midrule
$\ExecInj$  & \ppFortyEightExecTracked & \ppFortyEightExecElevated & \ppFortyEightExecRate \\
$\EvalQ$    & \ppFortyEightEvalTracked & \ppFortyEightEvalElevated & \ppFortyEightEvalRate \\
$\MPatch$   & \ppFortyEightPatchTracked & \ppFortyEightPatchElevated & \ppFortyEightPatchRate \\
$\HotRel$   & \ppFortyEightReloadTracked & \ppFortyEightReloadElevated & \ppFortyEightReloadRate \\
\midrule
\textbf{All kinds} & \textbf{\ppFortyEightTotalTracked} & \textbf{\ppFortyEightTotalElevated} & \textbf{\ppFortyEightTotalRate} \\
\bottomrule
\end{tabular}
\end{center}

All four mutation kinds achieve a \ppFortyEightTotalRate{} elevation
rate across our benchmark suite: every tracked mutation was
successfully elevated to $\Truntime$, confirming that the tracker
handles all four primitives reliably.
...
\midrule
$\ExecInj$  & \ppFortyEightExecMedian & \ppFortyEightExecPctile \\
$\EvalQ$    & \ppFortyEightEvalMedian & \ppFortyEightEvalPctile \\
$\MPatch$   & \ppFortyEightPatchMedian & \ppFortyEightPatchPctile \\
$\HotRel$   & \ppFortyEightReloadMedian & \ppFortyEightReloadPctile \\
\bottomrule
\end{tabular}
\end{center}

$\HotRel$ is cheapest (\ppFortyEightReloadMedian{} median) because the
reload path short-circuits when no module state changes.
$\ExecInj$ is most expensive (\ppFortyEightExecMedian{} median) because
the \texttt{DescentPlanner} computes a full namespace snapshot before
and after code injection.
