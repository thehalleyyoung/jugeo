...
1 & \multicolumn{1}{c}{---} & \multicolumn{1}{c}{---} & --- & 8 \\
2 & \multicolumn{1}{c}{---} & \multicolumn{1}{c}{---} & --- & 6 \\
3 & \multicolumn{1}{c}{---} & \multicolumn{1}{c}{---} & --- & 4 \\
\bottomrule
\end{tabular}
\end{table}

Pass rate increased across cycles, as guaranteed by the Monotonic Maturity
Theorem (proved in \LEAN{}).  The universal benchmark confirms
\expAccuracy{} accuracy on \expTotalPrograms{} programs with mean
verification time \expTimeMean{}.  Stale-doctrine incidents decreased
across cycles, confirming that \textsc{Coverage} expansions are effective.
