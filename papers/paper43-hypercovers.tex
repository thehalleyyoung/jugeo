...
\textbf{Method} & \textbf{Missed edges} & \textbf{Constr.\ (ms)} &
  \textbf{Verif.\ (ms)} \\
\midrule
Flat Čech  & \emph{higher}  & \subHypercovertreatySmallTime & \ppFortyThreeFlatVerifTime \\
Hypercover & \emph{lower}   & \subHypercovertreatySmallTime & \ppFortyThreeHyperVerifTime \\
\bottomrule
\end{tabular}
\end{table}
