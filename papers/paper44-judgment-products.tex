...
\midrule
Specification  & \numspec{}  & 189 & 94.2 & 81.5 \\
Equivalence    & \numeq{}    & 194 & 91.8 & 78.4 \\
Bug detection  & \numbug{}   & 173 & 88.4 & 62.1 \\
\midrule
\textbf{Total} & \numcases{} & 556 & 91.5 & 74.3 \\
\bottomrule
\end{tabular}
\end{table}
...
We verify Theorem~\ref{thm:soundness}(ii) on all 556 constructed
products by checking that $\trust(P) = \min(\trust(J_1), \trust(J_2))$
for each binary product.  The check passes for 100\% of cases (556/556),
confirming the correctness of the trust propagation implementation.
...
maximum of 42\,ms for the most complex multi-component products.
Total computation time over all 556 products: 3.7\,s.  This is
dominated by proposition manipulation; the trust and evidence
operations each take under 0.1\,ms.
