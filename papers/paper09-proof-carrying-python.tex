...
SEMANTIC & 16 & 5.1\% \\
\midrule
\textbf{Total} & \expPropsSum{} & 100.0\% \\
\bottomrule
\end{tabular}
\end{table}

\Cref{tab:prop-kinds} shows the distribution of proposition kinds.
Structural and behavioral propositions dominate (77.8\% combined),
...
propositions (10.0\%) arise primarily in data structures and web
utilities, where multiple coordinated state variables must be kept
consistent.  Resource propositions (7.1\%) appear in programs with
capacity bounds or complexity guarantees.  Semantic propositions
(5.1\%) capture domain-specific properties like sort stability and
termination.
