...
completion closes previously unprovable verification conditions
with sub-millisecond median latency overhead per completion step.
\end{abstract}
...
\midrule
\EAGER    & High          & Zero        & \subSiteSuccessRate \\
\LAZY     & Medium        & Low         & \subSiteSuccessRate \\
\DEMAND   & Zero          & Medium      & — \\
\bottomrule
\end{tabular}
\end{table}
...
\textsc{semantic}     & — & — & — & — \\
\midrule
\textbf{Total (site calls)} & \subSiteCalls & — & \subSiteSuccessful & \textbf{\subSiteSuccessRate} \\
\bottomrule
\end{tabular}
\end{table}
