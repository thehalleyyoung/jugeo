...
\begin{table}[H]
  ...
  \begin{tabular}{lrrrr}
    ...
    Mixed IO             & — & —   & —    & — \\
    \midrule
    Overall (universal benchmark) & \expAccuracy & \expPropsSum & — & \expObstructionTotal \\
    \bottomrule
  \end{tabular}
\end{table}

\paragraph{Effect classification.}
The \texttt{AsyncAnalyzer} achieves \expAccuracy{} accuracy on the universal benchmark of \expTotalPrograms{} programs.
On the CLI verification suite, \subCliAccuracy{} of programs verify successfully.  Any misclassifications arise
...
the analysis completes with mean time \expTimeMean{} on the universal benchmark.  The
