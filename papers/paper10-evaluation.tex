...
\textbf{Strategy} & \textbf{Mean Time} & \textbf{Total Time}
  & \textbf{Overhead} \\
\midrule
\texttt{EAGER}      & \compDescentEagerMeanMs\,ms & \compDescentEagerRuns{} runs & baseline \\
\texttt{EXHAUSTIVE} & \compDescentExhaustiveMeanMs\,ms & \compDescentExhaustiveRuns{} runs & \compDescentExhaustiveRate \\
\texttt{ITERATIVE}  & \compDescentIterativeMeanMs\,ms & \compDescentIterativeRuns{} runs & \compDescentIterativeRate \\
\texttt{OPTIMISTIC} & \compDescentOptimisticMeanMs\,ms & \compDescentOptimisticRuns{} runs & \compDescentOptimisticRate \\
\bottomrule
\end{tabular}
\end{table}
