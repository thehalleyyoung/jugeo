...
\midrule
None      & $47.3 \pm 3.1$      & $44.8 \pm 2.9$     & $0.943$      \\
Moderate  & $31.2 \pm 2.4$      & $30.9 \pm 2.3$     & $0.951$      \\
Heavy     & $14.7 \pm 1.8$      & $14.5 \pm 1.6$     & $0.961$      \\
\bottomrule
\end{tabular}
\end{table}
...
$0.21 \pm 0.04\,\mathrm{ms}$, contributing negligibly to total verification
latency (\medtime{} median, \totaltime{} total for \numcases{} tasks).

\subsection{Effect of specialization}

Fleets with mixed specializations outperform homogeneous fleets by
$8.3\%$ on evidence score (mean across all patches).  The affinity function
