...
\providecommand{\bpctrl}{\mathsf{bp}}              % backpressure control
\providecommand{\argmax}{\operatorname*{argmax}}    % argmax operator
\providecommand{\Props}{\mathbb{P}}                 % proposal multiset
\providecommand{\Bsig}{\mathbf{b}}                  % backpressure signal
...
\providecommand{\Stabilizing}{\ensuremath{\mathsf{STABILIZING}}}
\providecommand{\Mature}{\ensuremath{\mathsf{MATURE}}}
...
\midrule
None      & \ppTwelveNoneProdRate{}  & \ppTwelveNoneIntRate{}  & \ppTwelveNoneSuccessRate{} \\
Moderate  & \ppTwelveModProdRate{}   & \ppTwelveModIntRate{}   & \ppTwelveModSuccessRate{} \\
Heavy     & \ppTwelveHeavyProdRate{} & \ppTwelveHeavyIntRate{} & \ppTwelveHeavySuccessRate{} \\
\bottomrule
\end{tabular}
\end{table}
...
\hline
1 & \ppTwelveConvRoundOne{} \\
3 & \ppTwelveConvRoundThree{} \\
5 & \ppTwelveConvRoundFive{} \\
\hline
\end{tabular}
