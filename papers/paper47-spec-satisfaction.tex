...
\midrule
\texttt{FORWARD} (A refines B) & 15 & \suppForwardBothOk/\suppForwardPairs \\
\texttt{EQUIVALENT}            & \subEquivTotal & \subEquivVerified/\subEquivTotal \\
\texttt{INCOMPARABLE}          & 15 & \suppIncompBothOk/\suppIncompPairs \\
\midrule
\textbf{Overall}               & 40 & \suppTotalPairs{} total pairs verified \\
\bottomrule
\end{tabular}
\end{table}
