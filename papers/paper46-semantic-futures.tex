...
\midrule
$\RKcov$  & 112 & 108 & 0.94 & 0.96 \\
$\RKtheo$ &  67 &  71 & 0.91 & 0.96 \\
$\RKpack$ &  54 &  52 & 0.98 & 0.94 \\
$\RKinv$  &  67 &  69 & 0.93 & 0.96 \\
\midrule
...
Regime bootstrapping achieves $94\%$ weighted precision across the four
regimes.  $\RKpack$ is the easiest to detect (step-function signature);
$\RKtheo$ is hardest (non-monotone noise).
...
The measured $\StepsToDecide$ tracks the $O(\log N)$ prediction of
Theorem~\ref{thm:accuracy} within $15\%$ across all regimes.
...
\midrule
Overall            & \multicolumn{1}{c}{---} & \expAccuracy \\
\bottomrule
\end{tabular}
\end{center}
