...
\cmidrule(lr){3-4}\cmidrule(lr){5-6}
  ...
  & \textbf{Greedy} & \textbf{BFS} \\
\midrule
$\leq$50  & \ppElevenTotalPrograms{} & \ppElevenGreedyMeanCoords{} & \ppElevenBfsMeanCoords{} & \ppElevenMeanBuildTime{} & \ppElevenMeanBuildTime{} \\
\bottomrule
\end{tabular}
\end{table}
...
\midrule
Coverage ratio ($\uparrow$)     & \ppElevenMeanCovRatio{} & \ppElevenMeanCovRatio{} & \ppElevenMeanCovRatio{} \\
Covering axiom pass rate        & \ppElevenAllAxiomsPass{} & \ppElevenAllAxiomsPass{} & \ppElevenAllAxiomsPass{} \\
Overlap density                 & \ppElevenMeanOverlap{} & \ppElevenMeanOverlap{} & \ppElevenMeanOverlap{} \\
Branching factor               & \ppElevenMeanBranchFactor{} & \ppElevenMeanBranchFactor{} & \ppElevenMeanBranchFactor{} \\
Mean depth                     & \ppElevenMeanDepth{} & \ppElevenMeanDepth{} & \ppElevenMeanDepth{} \\
Entropy                        & \ppElevenMeanEntropy{} & \ppElevenMeanEntropy{} & \ppElevenMeanEntropy{} \\
\bottomrule
\end{tabular}
\end{table}
