...
We validate the framework on the repository benchmark of 8 packs and 6
pairings, discovering 78 bridges of which 50 are structurally valid
(64.1\%) with mean discovery time \medtime{}.
\end{abstract}
...
We evaluated the pack federation framework on the benchmark reported in
\texttt{data-paper37.tex}: 8 packs, 6 pack pairs, and 78 discovered
bridges.
...
\begin{table}[h]
\centering
\caption{Bridge discovery and verification statistics across the audited
benchmark.
...
\midrule
alpha--beta   & --- & --- & \multicolumn{1}{c}{\ppXXXVIIAlphaBetaValidPct} & \multicolumn{1}{c}{\ppXXXVIIAlphaBetaDiscTime} \\
alpha--gamma  & --- & --- & \multicolumn{1}{c}{\ppXXXVIIAlphaGammaValidPct} & \multicolumn{1}{c}{\ppXXXVIIAlphaGammaDiscTime} \\
beta--gamma   & --- & --- & \multicolumn{1}{c}{\ppXXXVIIBetaGammaValidPct} & \multicolumn{1}{c}{\ppXXXVIIBetaGammaDiscTime} \\
\emph{all 6 pairs} & \multicolumn{2}{c}{78 bridges total} & \subSiteSuccessRate & \totaltime \\
\bottomrule
\end{tabularx}
\end{table}

Across the audited benchmark, 78 bridges are discovered and 50 are
valid.  The current implementation therefore leaves a substantial tail
of unresolved cross-pack relationships.
