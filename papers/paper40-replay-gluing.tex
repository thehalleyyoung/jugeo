...
Experiments on \numcases{} benchmarks confirm the Replay Determinism
Theorem: replayed global sections match the originals, with replay
subsystem timing of \subReplaygluingSmallTime{} (small programs).
\end{abstract}
...
\midrule
$\StratFull$  & \subReplaygluingSmallTime & --- & $0\%$  & $0 / \numcases$ \\
$\StratInc$   & \subReplaygluingSmallTime & --- & ---    & $0 / \numcases$ \\
$\StratLazy$  & \subReplaygluingSmallTime & --- & ---    & $0 / \numcases$ \\
$\StratAdapt$ & \subReplaygluingSmallTime & --- & ---    & $0 / \numcases$ \\
\bottomrule
\end{tabular}
\end{table}
...
Metric & Mean & Std dev \\
\midrule
Patches recovered from checkpoint & \multicolumn{2}{c}{\emph{majority}} \\
Patches recovered from suffix log  & \multicolumn{2}{c}{\emph{remainder}} \\
Patches synthesised by closure     & \multicolumn{2}{c}{$< 1\%$} \\
Total replay time                  & \multicolumn{2}{c}{\subReplaygluingSmallTime} \\
\bottomrule
\end{tabular}
\end{table}
...
divergences.  Detection latency was sub-millisecond per task.
