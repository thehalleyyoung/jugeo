...
The PID controller reduces average steps-to-convergence
relative to the Priority baseline and substantially relative to FIFO.
Peak obstruction counts drop by half, and trust-drop episodes are
substantially reduced (the integral term detects impending trust collapses
