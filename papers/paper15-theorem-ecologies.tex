...
$\fitbar^* \approx 0.82$ after approximately 60 generations,
consistent with Theorem~\ref{thm:stability}(ii).

\begin{table}[H]
  \centering
  \caption{Ecology metrics at generations 0, 25, 50, 100.}
  \label{tab:ecology-metrics}
  \begin{tabular}{lrrrr}
    \toprule
    Metric & Gen 0 & Gen 25 & Gen 50 & Gen 100 \\
    \midrule
    Population size  & 2847 & 500 & 500 & 500 \\
    Mean fitness     & 0.31 & 0.61 & 0.76 & 0.82 \\
    Species diversity & 142  & 89   & 74   & 68   \\
    Coverage (\%)    & 47.2 & 68.4 & 79.1 & 83.7 \\
    Mean dep.\ clauses & 4.1  & 3.2  & 2.8  & 2.5  \\
    \bottomrule
  \end{tabular}
\end{table}
...
coverage reduction of $3.2\%$ relative to \textsc{FitnessConverged}.

\paragraph{Economics layer impact.}
Enabling the valuation-based budget allocation
(Proposition~\ref{prop:waterfilling}) reduces total solver time by
$18\%$ relative to uniform budget allocation, confirming that
...
increases from $1.4$ (generation 0) to $6.8$ (generation 100),
demonstrating 4.9$\times$ compounding of verification effort.
...
\begin{enumerate}[leftmargin=1.5em]
  ...
  \item An economics layer providing supply/demand valuation and
    water-filling budget allocation, with a $18\%$ empirical efficiency
    gain.
