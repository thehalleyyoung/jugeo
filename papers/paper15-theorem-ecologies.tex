...
\begin{table}[H]
  ...
  \begin{tabular}{lrrrr}
    ...
    \midrule
    \multicolumn{5}{l}{\emph{Ecology evolution over \expTotalPrograms{} programs: population}} \\
    \multicolumn{5}{l}{\emph{converges to carrying capacity $K$ (Theorem~\ref{thm:stability}).}} \\
    \multicolumn{5}{l}{\emph{Coverage verified via the universal benchmark:}} \\
    \multicolumn{5}{l}{\emph{\expAccuracy{} accuracy, \expPropsSum{} properties checked.}} \\
    \bottomrule
  \end{tabular}
\end{table}
