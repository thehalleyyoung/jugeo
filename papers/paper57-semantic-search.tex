...
\subsection{Analysis}
The \compTrustSolverdischargedPct\ solver-discharge rate across
...
this to behavioral specifications and trust levels.

\paragraph{Semantic Code Search.}
CodeBERT~\cite{CodeBERT2020} and UniXcoder embed code into vector spaces
...
code search over semantic sites.
...
success, and \compTrustSolverdischargedPct\ solver-level trust.  Future
work targets incremental index updates, LLM-based query compilation,
and scaling to repository-level corpora.
