...
\begin{tabular}{lrrrr}
  ...
  \midrule
  \multicolumn{5}{l}{\emph{Evaluated on the \expTotalPrograms-program benchmark.}} \\
  \multicolumn{5}{l}{\emph{Full $\AD$ eliminates spurious obstructions (\expObstructionTotal{} obstructions}} \\
  \multicolumn{5}{l}{\emph{in universal benchmark); mean time \expTimeMean.}} \\
  \multicolumn{5}{l}{\emph{Soundness guaranteed by Theorem~\ref{thm:soundness}.}} \\
  \bottomrule
\end{tabular}
\end{center}

The full $\AD$ configuration eliminates spurious Čech
obstructions, as confirmed on the \expTotalPrograms-program benchmark
(\expObstructionTotal{} obstructions, \expAccuracy{} accuracy,
mean time \expTimeMean).  Level-2 and Level-3 detection contribute
additional \NoAlias{} classification over Level-1 alone.
...
\begin{tabular}{lrr}
  ...
  \midrule
  \multicolumn{3}{l}{\emph{Across all \expTotalPrograms{} programs: zero misses.}} \\
  \multicolumn{3}{l}{\emph{\expPropsSum{} properties checked, \expPropsOkSum{} OK.}} \\
  \multicolumn{3}{l}{\emph{Soundness guaranteed by Theorem~\ref{thm:soundness}.}} \\
  \bottomrule
\end{tabular}
\end{center}
...
\begin{tabular}{lrr}
  ...
  \midrule
  \multicolumn{3}{l}{\emph{Alias-aware encoding increases assertion count but enables}} \\
  \multicolumn{3}{l}{\emph{additional lemma proofs.  Overall benchmark: \expPropsSum{} properties,}} \\
  \multicolumn{3}{l}{\emph{\expAccuracy{} accuracy, mean time \expTimeMean.}} \\
  \bottomrule
\end{tabular}
\end{center}
