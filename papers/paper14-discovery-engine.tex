...
\textbf{Strategy} & \textbf{Found} & \textbf{Useful} & \textbf{Provable}
  & \textbf{Time (s)} \\
\midrule
\alg{EXHAUSTIVE} & \ppFourteenDiscoveredInvariants{} & \ppFourteenTotalPropsOk{} & \ppFourteenTotalPropsOk{} & \ppFourteenMeanDiscoveryTime{} \\
\alg{HYBRID}     & \ppFourteenDiscoveredInvariants{} & \ppFourteenTotalPropsOk{} & \ppFourteenTotalPropsOk{} & \ppFourteenMeanDiscoveryTime{} \\
Manual           & ---                                & ---                        & ---                        & ---                           \\
\bottomrule
\end{tabularx}
\end{table}
...
\midrule
\alg{SEMANTIC}    & \ppFourteenTotalPrograms{} & \ppFourteenDiscoveredInvariants{} & \ppFourteenTotalPropsOk{} & \ppFourteenVerifiedCount{} \\
\alg{STRUCTURAL}  & \ppFourteenTotalPrograms{} & \ppFourteenDiscoveredInvariants{} & \ppFourteenTotalPropsOk{} & \ppFourteenVerifiedCount{} \\
\alg{TOPOLOGICAL} & \ppFourteenTotalPrograms{} & \ppFourteenDiscoveredInvariants{} & \ppFourteenTotalPropsOk{} & \ppFourteenVerifiedCount{} \\
\alg{HYBRID}      & \ppFourteenTotalPrograms{} & \ppFourteenDiscoveredInvariants{} & \ppFourteenTotalPropsOk{} & \ppFourteenVerifiedCount{} \\
\bottomrule
\end{tabular}
\end{table}
...
\textbf{KLOC} & \textbf{Nodes} & \textbf{Invariants found}
  & \textbf{Wall time (min)} \\
\midrule
5   & 8 & \ppFourteenDiscoveredInvariants{} & \ppFourteenMeanDiscoveryTime{} \\
50  & 8 & \ppFourteenDiscoveredInvariants{} & \ppFourteenMeanDiscoveryTime{} \\
180 & 8 & \ppFourteenDiscoveredInvariants{} & \ppFourteenTotalDiscoveryTime{} \\
\bottomrule
\end{tabular}
\end{table}
