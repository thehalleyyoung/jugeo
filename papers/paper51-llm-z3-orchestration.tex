...
\subsection{Analysis}
The pipeline achieves \expAccuracy\ accuracy, verifying \expVerified\ out of 
\expTotalPrograms\ programs. The mean verification time is \expTimeMean, with 
orchestration overhead negligible (\subOrchestrateverificationSmallTime). 
This demonstrates that the LLM-Z3 hybrid is both \emph{practical} and 
\emph{sound}.
