...
\begin{tabular}{@{}lrr@{}}
\toprule
\textbf{Fragment} & \textbf{Sample obligations} &
  \textbf{Mean time} \\
\midrule
\QFUF{}      & \ppThirteenFragQFUF{} & \ppThirteenQFUFMeanTime{} \\
\QFLIA{}     & \ppThirteenFragQFLIA{} & \ppThirteenQFLIAMeanTime{} \\
\QFBV{}      & \ppThirteenFragQFBV{} & \ppThirteenQFBVMeanTime{} \\
Nonlinear    & \ppThirteenFragNonlinear{} & \ppThirteenNonlinearMeanTime{} \\
\bottomrule
\end{tabular}
\end{table}
...
\begin{tabular}{@{}lrrrr@{}}
\toprule
\textbf{Suite} & \textbf{Programs} & \textbf{Gaps detected} &
  \textbf{Precision} & \textbf{Recall} \\
\midrule
Arithmetic   & \ppThirteenArithPrograms{} & \ppThirteenArithGaps{} & \ppThirteenArithPrecision{} & \ppThirteenArithRecall{} \\
Collections  & \ppThirteenCollectPrograms{} & \ppThirteenCollectGaps{} & \ppThirteenCollectPrecision{} & \ppThirteenCollectRecall{} \\
Higher-order & \ppThirteenHigherPrograms{} & \ppThirteenHigherGaps{} & \ppThirteenHigherPrecision{} & \ppThirteenHigherRecall{} \\
\bottomrule
\end{tabular}
\end{table}
...
\midrule
All programs & \ppThirteenTotalDeclarations{} & \ppThirteenMeanDeclsPerCoord{} & \ppThirteenMeanAssertsPerCoord{} & \ppThirteenTotalAssertions{} \\
\bottomrule
\end{tabular}
\end{table}
