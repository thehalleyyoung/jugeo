...
semantics.
Evaluation on the \numcases-case \JuGeo{} benchmark shows that the
encoding pipeline processes each arithmetic obligation in a mean
time of $12\,\mathrm{ms}$, classifies $68\%$ of obligations into
\QFLIA{}, $22\%$ into \QFLRA{}, and $10\%$ into \QFBV{},
and achieves a gap-detection precision of $97\%$.
\end{abstract}
...
\[
  \hat{e}_k = \Bigl(\;k,\;
    \max_{e_i : k_i = k} c_i,\;
    \bigtjoin_{e_i : k_i = k} T_i\;\Bigr)
\]
where $\bigtjoin$ is the conservative join from Paper~4:
...
\textbf{Fragment} & \textbf{Obligations} & \textbf{\%} &
  \textbf{Mean time (ms)} \\
\midrule
\QFLIA{} & 1{,}632 & 68.0\% & 8.2  \\
\QFLRA{} &   528   & 22.0\% & 14.7 \\
\QFBV{}  &   240   & 10.0\% & 19.3 \\
\midrule
\textbf{Total} & 2{,}400 & 100\% & 10.7 \\
\bottomrule
\end{tabular}
\end{table}
...
statistics.
The mean grounding score of $0.94$ indicates that the evidence
...
\midrule
Spec.\ satisfaction & \numspec  & 0.96 & 12 & 100\% & 96\% \\
Equivalence         & \numeq   & 0.93 & 17 &  95\% & 94\% \\
Bug detection       & \numbug   & 0.94 & 11 &  97\% & 97\% \\
\midrule
\textbf{Total} & \numcases & \textbf{0.94} & \textbf{40}
  & \textbf{97\%} & \textbf{96\%} \\
\bottomrule
\end{tabular}
\end{table}
...
\PropAlg{} propagated trust at a mean depth of $2.3$ hops per
program, reaching up to $5$ hops in programs with long chains
...
\midrule
Spec.\ satisfaction & 148 & 2.1 & 4 & 63 \\
Equivalence         & 191 & 2.4 & 5 & 81 \\
Bug detection       & 127 & 2.3 & 5 & 52 \\
\midrule
\textbf{Total} & 466 & \textbf{2.3} & \textbf{5} & \textbf{196} \\
\bottomrule
\end{tabular}
\end{table}
